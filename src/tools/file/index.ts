...
export const FILE_VARIANTS: ActionVariant<FileAction>[] = [
    ...
    createZodActionVariant('export_markdown_snapshot', FileExportMarkdownSnapshotSchema, 'Export an auditable, paginated Markdown snapshot through SiYuan APIs without writing the host filesystem.'),
    ...
    createZodActionVariant('read_image', FileReadImageSchema, 'Read one document-referenced image and return it as an MCP image content block for direct visual analysis.'),
