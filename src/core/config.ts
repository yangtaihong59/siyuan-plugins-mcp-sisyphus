...
export const FILE_ACTIONS = ['upload_asset', 'list_templates', 'read_template', 'create_template', 'update_template', 'delete_template', 'save_doc_as_template', 'render', 'export_md', 'export_resources', 'list_unused_assets', 'get_doc_assets', 'audit_image_refs', 'get_image_ocr_text', 'remove_unused_assets', 'rename_asset', 'delete_asset', 'extract_doc'] as const;
...
const ACTION_TIERS: Record<ToolCategory, Record<string, ActionTier>> = {
    ...
    file: {
        ...
        get_doc_assets: 'basic', audit_image_refs: 'basic', extract_doc: 'basic',
        render: 'advanced',
...
export function buildDefaultToolConfig(): ToolConfig {
    return {
        ...
        file: {
            enabled: true,
            actions: createActionsRecord(FILE_ACTIONS, ['upload_asset', 'list_templates', 'read_template', 'create_template', 'update_template', 'save_doc_as_template', 'render', 'export_md', 'export_resources', 'list_unused_assets', 'get_doc_assets', 'audit_image_refs', 'get_image_ocr_text', 'remove_unused_assets', 'rename_asset', 'delete_asset', 'extract_doc']),
