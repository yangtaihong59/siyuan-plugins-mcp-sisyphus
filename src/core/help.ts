...
export const FS_GUIDANCE: string[] = [
    ...
    'fs.read always returns complete display-block windows. Use blockStart/blockLimit/tokenBudget to continue long documents; code, math, tables, lists, quotes, and other container blocks are never split. A window may slightly exceed tokenBudget, and leading headings stay with the first body block. The response includes a full heading outline and nextWindow when more blocks remain.',
